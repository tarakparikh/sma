...
#import the athdlFtpCls
import athdlFtpCls

#
#Create A new Instance of ftp class. It opens a connection
#
ftp2 = athdlFtpCls.AthdlFtpCls()

# Get A Count of total releases on FTP 
totalRel = ftp2.getReleaseCnt()
print "Total Releases ", totalRel
...
ftp2.closeConnection()

import yahoostock
aapl = yahoostock.get_all('AAPL')
print aapl
