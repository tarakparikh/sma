...
parser.add_argument("-n", dest = 'jobs_per_node', default = '20', type = 'int', help = 'Number of jobs per node')
parser.add_argument("-l", dest = 'logfile', default = 'HW.log', type = 'string', help = 'output log file')
